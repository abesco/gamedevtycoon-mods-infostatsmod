...
var InfoStatsModAbescoUG_Analysis = function(infoStatsModCore) {
        ...
        m.showSalesAnalysis = function(){
            ...
            if(GameManager.company.gameLog.length > 0)
            {
                ...
                var $table = m.getModalWindowContentAreaDataTableElement();
        ...
        m.getRevenuesDataArray = function() {
            var data = [];
        ...
        m.getModalWindowContentAreaDataTableElement = function() {
        ...
        m.getSalesAsDivElement = function () {
